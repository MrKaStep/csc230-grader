...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-fugitive,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
...
silent only
silent tabonly
cd ~/taing/csc230/grader/projects
...
wincmd w
argglobal
if bufexists("REVIEW_PATH") | buffer REVIEW_PATH | else | edit REVIEW_PATH | endif
balt ROOT/base.c
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
wincmd w
argglobal
if bufexists("ROOT/operation.h") | buffer ROOT/operation.h | else | edit ROOT/operation.h | endif
balt ROOT/operation.c
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
